    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-6 mb-10">
      ...
      <AnimatedCard>
        <div className="relative overflow-hidden bg-gradient-to-br from-green-600 to-green-800 rounded-3xl p-7 shadow-2xl">
          ...
          <h2 className="text-6xl font-black mt-4 text-white">
            <AnimatedCounter value={contactados} />
          </h2>
      ...
      <AnimatedCard>
        <div className="relative overflow-hidden bg-gradient-to-br from-purple-600 to-purple-800 rounded-3xl p-7 shadow-2xl">
          ...
          <h2 className="text-6xl font-black mt-4 text-white">
            <AnimatedCounter value={cerrados} />
          </h2>
      ...
      <AnimatedCard>
        <div className="relative overflow-hidden bg-gradient-to-br from-pink-600 to-pink-800 rounded-3xl p-7 shadow-2xl">
          ...
          <h2 className="text-3xl font-black mt-4 text-white whitespace-nowrap tracking-tight">
      ...
      <AnimatedCard>
        <div className="relative overflow-hidden bg-gradient-to-br from-cyan-600 to-cyan-800 rounded-3xl p-7 shadow-2xl">
          <div className="absolute -right-8 -top-8 w-32 h-32 bg-white/10 rounded-full" />
          ...
          <h2 className="text-3xl font-black mt-4 text-white whitespace-nowrap tracking-tight">
            ${forecastRevenue.toLocaleString("en-US")}
          </h2>
